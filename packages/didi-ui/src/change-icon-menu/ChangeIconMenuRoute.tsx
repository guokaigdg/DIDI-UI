...
import { ShowEmoji, SearchEmoji } from "../index";
...
function EmojiIcon(props: { onClickUploadEmoji: any }) {
  //todo
  ...
  //更新常用emoji列表, 限定成长度为20个
  const updateRecentList = (newEmoji: string) => {
  ...
  const handleOnClickEmoji = (result: string) => {
...
function UploadImage(props: { onClickUploadImage: any }) {
...
function ChangeIconMenuRoute(props: { chooseImage: any; onClickEmoji: any }) {
